...
def prep():
    ...
    nodes = [Node(text=get_random_text(), index=idx, children=set(), embeddings=[]) for idx in range(50)]
    ...
    def randomly_connect_nodes(parent_nodes : List[Node], potential_children : List[Node]):
